const restaurants = [
  {
    ...
    restaurant_info: {
      ...
      site_url: "",
      location_img: "",
      restaurant_url: "/restaurant/121721/menu",
      payment_methods: [
        {
          id: "1",
      ...
      restaurant_images: ["img1.png", "img2.png", "img3.png"],
    },
    restaurant_time_info: {
      sat: [
        {
          open: "12:00:00",
          close: "22:30:00",
    ...
    categorys: [
        ...
        menu_items: [
          {
            ...
            position: 1,
            description: "Tender, Spicy and Juicy. Original or Peri_Crusted",
            images: [],
            sub_items: [
              {
                id: "224471",
          ...
          },
          {
            ...
            position: 2,
            description:
              "Chicken Livers Topped with PERi_PERi Sauce, Served with A Roll To Soak Up The Sauce",
            images: [],
            sub_items: [
              {
                id: "224474",
          ...
          },
          {
            ...
            position: 3,
            description: "Co_Starring Garlic, Pepper and Chili",
            images: [],
            sub_items: [
              {
                id: "224477",
          ...
          {
            id: "94307",
            name: "Hummus with PERI_PERI Drizzle (V)",
            position: 4,
            description:
              "Pour Smoky PERi_PERi Oil Over Creamy Hummus and Dig in with Strips Of Warm Pita",
            images: [],
            sub_items: [
              {
                id: "224480",
          ...
          },
          {
            ...
            position: 7,
            description:
              "Spicy Mixed Olives, Red Pepper Dip, Hummus with PERi_PERi Drizzle and Warm Pita Strips",
            images: [],
            sub_items: [
              {
                id: "224489",
        ...
        menu_items: [
          {
            ...
            position: 10,
            description:
              "Quarter Chicken Marinated with PERi_PERi Sauce and Grilled",
            images: [],
            sub_items: [
              {
                id: "224543",
                ...
                consumable: "1:1",
                cuisine_name: "Indian",
                category_name: "Peri_peri chicken",
                discount: {
                  type: "",
                  amount: "0.00",
                },
          ...
          },
          {
            ...
            position: 11,
            description:
              "Half Chicken Marinated with PERi_PERi Sauce and Grilled",
            images: [],
            sub_items: [
              {
                id: "224552",
          ...
          },
          {
            ...
            position: 12,
            description: "Original Flavours or PERi_PEREi Crusted (P)",
            images: [],
            sub_items: [
              {
                id: "224561",
          ...
          },
          {
            ...
            name: "Wing Roulette",
            position: 13,
            description: "10 Wings in PERi_PERi Flavors",
            images: [],
            sub_items: [
              {
                id: "224570",
          ...
          },
          {
            ...
            position: 14,
            description:
              "Whole Chicken Marinated in PERi_PERi Sauce and Grilled",
            images: [],
            sub_items: [
              {
                id: "224573",
          ...
          },
          {
            ...
            position: 17,
            description:
              "Flame_Grilled PERi_PERi Thighs, Stuffed with Feta and Parsley, Skewered with Mixed Peppers",
            images: [],
            sub_items: [
              {
                id: "224594",
        ...
        menu_items: [
          {
            ...
            position: 19,
            description:
              "For 3_4 People, Whole Chicken with  2 Large or 4 Regular Rides",
            images: [],
            sub_items: [
              {
                id: "224615",
          ...
          },
          {
            ...
            position: 20,
            description:
              "For 2_3 People, Chicken Butterfly and a Espetada, with 2 Large or 4 Regular Sides",
            images: [],
            sub_items: [
              {
                id: "224621",
          ...
          },
          {
            ...
            name: "Jumbo Platter",
            position: 21,
            description: "For 4_6 People, 2 Whole Chickens and 5 Large Sides",
            images: [],
            sub_items: [
              {
                id: "224627",
      ...
      },
      {
        ...
        menu_items: [
          {
            id: "94319",
            name: "PERi_PERi Chips (P)",
            position: 23,
            description: "Crunchy Chips with PERi_PERi Sauce",
            images: [],
            sub_items: [
              {
                id: "224492",
        ...
        menu_items: [
          {
            ...
            position: 31,
            description:
              "PERi_PERi Chicken Thighs, Mixed Peppers, Chickpeas, Spicy Rice and Cataplana Sauce",
            images: [],
            sub_items: [
              {
                id: "224612",
      ...
      },
      {
        ...
        menu_items: [
          ...
          },
          {
            ...
            position: 34,
            description:
              "Served in A Toasted Wrap Full Of PERi_PERi Chicken, Crunchy Croutons, Parmesan Cheese and Sundried Tomatoes, All Smothered in Creamy Caesar Dressing",
            images: [],
            sub_items: [
              {
                id: "224648",
